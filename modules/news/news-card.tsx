  ...
  return (
    <article className="bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:border-white/20 transition-all duration-300 overflow-hidden group hover:bg-white/10">
      <div className="flex flex-col lg:flex-row">
        {/* Image Section */}
        <div className="w-full lg:w-80 h-48 sm:h-56 lg:h-auto lg:min-h-70 relative overflow-hidden bg-zinc-900/50 shrink-0">
          <Image
            fill
            src={news.images[0]}
            alt={news.title}
