...
interface Feature {
  ...
  readonly description: string;
  readonly icon: 'certified' | 'storage' | 'pricing' | 'expertise' | 'reach' | 'solutions';
}
...
export const OurProducts: FC<OurProductsProps> = ({
  ...
  const [hoveredProductId, setHoveredProductId] = useState<HoveredProductId>(null);
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <motion.h2 variants={variants.item} className="text-5xl font-black leading-tight mb-6">
          ...
          >
            Investment-grade bullion bars in gold, silver, platinum, and palladium, refined to
            international purity standards and available in kilo and large bar formats.
          </motion.p>
        </motion.div>
          ...
          {products.map((product: Product) => (
            ...
            >
              <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-amber-100 h-full flex flex-col">
                {/* Product Header */}
                <div className={`bg-linear-to-br ${product.color} p-8 text-white relative overflow-hidden`}>
                  <motion.div
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/90 text-sm">Purity: {product.purity}</p>
                  </div>
                </div>
                ...
                <div className="flex-1 p-8">
                  ...
                  <div className="space-y-4">
                    {product.specs.map((spec: ProductSpec, index: number) => (
                      ...
                      >
                        ...
                        <div>
                          <p className="font-semibold text-gray-900 text-sm">{spec.label}</p>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <p className="text-sm font-semibold text-gray-900 mb-3">Available Formats</p>
        ...
        <motion.div
          ...
          className="mb-24"
        >
          <motion.h3 variants={variants.item} className="text-4xl font-black text-center mb-16">
            Why SR Bullion
          </motion.h3>
        ...
        >
          <motion.h3 variants={variants.item} className="text-3xl font-black mb-6">
          ...
          >
            Get in touch with SR Bullion FZCO for wholesale precious metals delivered with integrity,
